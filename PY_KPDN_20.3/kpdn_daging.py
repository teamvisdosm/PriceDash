...
for (state, district, title), group in grouped:
    ...
    file_path = "E:/PI/HTML_KPDN_20.3/DAGING/DISTRICT/{}_{}_{}.html".format(title.replace("*", "_").replace("/", "_").replace("\\", "_"), state, district)
...
for (state, premise_type, title), group in gp_type:
    ...
    file_path = "E:/PI/HTML_KPDN_20.3/DAGING/PREMISE/{}_{}_{}.html".format(title.replace("(", "_").replace(")", "_").replace("*", "_").replace("/", "_").replace("\\", "_"), state, premise_type.replace("/", "_"))
    line.render(file_path)