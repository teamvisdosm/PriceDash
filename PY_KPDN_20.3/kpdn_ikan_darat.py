...
df = df[df['item_category'] == 'IKAN DARAT']
...
for (state, district, title), group in grouped:
    ...
    file_path = "E:/PI/charts/IKAN DARAT/DISTRICT/{}_{}_{}.html".format(title, state, district)
...
for (state, premise_type, title), group in gp_type:
    ...
    file_path = "E:/PI/charts/IKAN DARAT/PREMISE/{}_{}_{}.html".format(title, state, premise_type.replace("/", "_"))
    line.render(file_path)