...
df = df[df['item_category'] == 'SAYUR-SAYURAN']
...
for (state, district, title), group in grouped:
    ...
    file_path = "E:/PI/charts/SAYUR-SAYURAN/DISTRICT/{}_{}_{}.html".format(title.replace("/", "_"), state, district)
...
for (state, premise_type, title), group in gp_type:
    ...
    file_path = "E:/PI/charts/SAYUR-SAYURAN/PREMISE/{}_{}_{}.html".format(title.replace("/", "_"), state, premise_type.replace("/", "_"))
    line.render(file_path)